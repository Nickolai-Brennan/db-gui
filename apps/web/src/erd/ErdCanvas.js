...
export function ErdCanvas({ nodes, edges }) {
    ...
    return (_jsxs("div", { className: "relative flex-1 bg-zinc-50 overflow-hidden", children: [_jsxs("div", { className: "absolute top-3 right-3 z-20 flex items-center gap-2", children: [_jsx("button", { className: "px-3 py-1.5 rounded-xl border border-zinc-200 bg-white text-sm", onClick: resetViewport, children: "Reset view" }), _jsxs("div", { className: "px-3 py-1.5 rounded-xl border border-zinc-200 bg-white text-sm", children: [Math.round(viewport.zoom * 100), "%"] })] }), _jsx("div", { className: "absolute inset-0", style: {
                    backgroundImage: 'linear-gradient(to right, rgba(0,0,0,0.05) 1px, transparent 1px), linear-gradient(to bottom, rgba(0,0,0,0.05) 1px, transparent 1px)',
                    backgroundSize: '40px 40px',
                } }), _jsx("div", { ref: stageRef, className: "absolute inset-0", onWheel: onWheel, onPointerDown: onPointerDownBg, children: _jsxs("div", { style: stageStyle, children: [_jsx("svg", { width: 6000, height: 6000, style: { position: 'absolute', left: 0, top: 0, pointerEvents: 'none' }, children: edgePaths.map((p) => {
                                ...
                                return (_jsx("path", { d: p.d, fill: "none", stroke: stroke, strokeWidth: strokeWidth }, p.key));
                            }) }), nodes.map((n) => (_jsx(TableNodeCard, { node: n }, n.key)))] }) })] }));
}
